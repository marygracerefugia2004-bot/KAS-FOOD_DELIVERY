...
<nav>
    ...
    <div class="nav-buttons">
        @auth
            <a href="{{ auth()->user()->isAdmin() ? route('admin.dashboard') : (auth()->user()->isDriver() ? route('driver.dashboard') : route('user.dashboard')) }}" class="btn btn-primary">Go to Dashboard</a>
...
<div class="main-container">
    ...
    <div class="hero">
        <div class="hero-content">
            ...
            <div class="hero-cta">
                @auth
                    <a href="{{ auth()->user()->isAdmin() ? route('admin.dashboard') : (auth()->user()->isDriver() ? route('driver.dashboard') : route('user.dashboard')) }}" class="btn btn-primary">
        ...
        <div class="hero-visual">
            ...
            <img src="{{ asset('images/hero-delivery.png') }}" alt="KAS Delivery" class="hero-img" onerror="this.onerror=null;this.src='https://placehold.co/450x450/0F172A/FF6B2C?text=KAS+Delivery';">
        </div>
    </div>
    ...
    <section id="contact">
        <div class="container">
            <div class="cta-box fade-up">
                ...
                @auth
                    <a href="{{ auth()->user()->isAdmin() ? route('admin.dashboard') : (auth()->user()->isDriver() ? route('driver.dashboard') : route('user.dashboard')) }}" class="btn btn-primary"><i class="fas fa-arrow-right"></i> Open Dashboard</a>
                @else
                    <a href="{{ route('register') }}" class="btn btn-primary"><i class="fas fa-user-plus"></i> Create Account</a>
                @endauth
            </div>
        </div>
    </section>
