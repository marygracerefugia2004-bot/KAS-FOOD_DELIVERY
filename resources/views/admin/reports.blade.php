...
<div style="max-width: 1200px; margin: 0 auto; padding: 1rem;">
    ...
    <div class="stats-grid" style="margin-bottom: 1.5rem;">
        <div class="stat-card">
            ...
            <div class="stat-val">₱{{ number_format($monthly->sum('revenue'), 2) }}</div>
            <div class="stat-lbl">Total Revenue</div>
        </div>
        <div class="stat-card">
            <div class="stat-ico ico-navy"><i class="fas fa-box"></i></div>
            <div class="stat-val">{{ $monthly->sum('total') }}</div>
            <div class="stat-lbl">Total Orders</div>
        </div>
        <div class="stat-card">
            <div class="stat-ico ico-green"><i class="fas fa-chart-line"></i></div>
            <div class="stat-val">₱{{ number_format($monthly->avg('revenue'), 2) }}</div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $report->total }}</td>
                        <td style="color: var(--orange); font-weight: 700;">₱{{ number_format($report->revenue, 2) }}</td>
                        <td>₱{{ number_format($report->revenue / $report->total, 2) }}</td>
                    </tr>
                    @empty
                    <tr>
