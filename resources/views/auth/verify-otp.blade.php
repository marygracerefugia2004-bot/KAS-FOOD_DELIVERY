...
<div class="card">
    ...
    @if(session('success'))
        <div style="background:#05966920;border-color:#059669;color:#6EE7B7;padding:.75rem;border-radius:10px;margin-bottom:1rem">{{ session('success') }}</div>
    @endif
    ...
    <form method="POST" action="{{ route('otp.verify') }}">
        ...
        <div class="form-group" style="margin-bottom:1rem">
            ...
            @error('otp') <span style="color:#F87171;font-size:.8rem">{{ $message }}</span> @enderror
        </div>
