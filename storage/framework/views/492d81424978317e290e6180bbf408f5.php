<!DOCTYPE html>
<html lang="en" class="<?php echo e(auth()->user()?->dark_mode ? 'dark' : ''); ?>">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
<title><?php echo $__env->yieldContent('title','KAS Delivery'); ?> — KAS</title>
...
<header class="topbar">
    ...
    <a href="<?php echo e(auth()->check() ? (auth()->user()->isAdmin() ? route('admin.dashboard') : (auth()->user()->isDriver() ? route('driver.dashboard') : route('user.dashboard'))) : '/'); ?>" class="topbar-brand">
    ...
    <div class="topbar-center">
        <span class="topbar-page-title"><?php echo $__env->yieldContent('page-title', ''); ?></span>
    </div>
    ...
    <div class="topbar-right">
        ...
        <a href="<?php echo e(route('user.cart')); ?>" class="t-btn" title="Cart" style="position:relative">
        ...
        <a href="<?php echo e(route('messages.index')); ?>" class="t-btn" title="Messages">
            <i class="fas fa-comments"></i>
        </a>

        
        <a href="<?php echo e(route('notifications.index')); ?>" class="t-btn" title="Notifications" style="position:relative">
        ...
        <span class="t-role-badge"><?php echo e(ucfirst(auth()->user()->role)); ?></span>

        
        <a href="<?php echo e(auth()->user()->isAdmin() ? '#' : (auth()->user()->isDriver() ? route('driver.profile') : route('user.profile'))); ?>" class="t-user-pill" title="Profile">
            <div class="t-initials"><?php echo e(strtoupper(substr(auth()->user()->name, 0, 2))); ?></div>
            <span class="t-user-name"><?php echo e(auth()->user()->name); ?></span>
        </a>
...
<div id="toast-area">
    <?php if(session('success')): ?>
        <div class="toast toast-success fade-up"><i class="fas fa-check-circle"></i><?php echo e(session('success')); ?></div>
    <?php endif; ?>
    <?php if(session('error')): ?>
        <div class="toast toast-danger fade-up"><i class="fas fa-exclamation-circle"></i><?php echo e(session('error')); ?></div>
    <?php endif; ?>
</div>
...
<div class="app-shell">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <a href="<?php echo e(route('user.dashboard')); ?>"       class="sidebar-link <?php echo $__env->yieldContent('sl-dashboard'); ?>"><span class="sl-icon"><i class="fas fa-home"></i></span>Dashboard</a>
        <a href="<?php echo e(route('user.foods')); ?>"           class="sidebar-link <?php echo $__env->yieldContent('sl-foods'); ?>"><span class="sl-icon"><i class="fas fa-utensils"></i></span>Browse Food</a>
        <a href="<?php echo e(route('user.orders.history')); ?>"  class="sidebar-link <?php echo $__env->yieldContent('sl-orders'); ?>"><span class="sl-icon"><i class="fas fa-box"></i></span>My Orders</a>
        <a href="<?php echo e(route('user.favorites')); ?>"       class="sidebar-link <?php echo $__env->yieldContent('sl-favs'); ?>"><span class="sl-icon"><i class="fas fa-heart"></i></span>Favorites</a>

        <div class="sidebar-divider"></div>
        <div class="sidebar-section">Account</div>

        <a href="<?php echo e(route('messages.index')); ?>" class="sidebar-link <?php echo $__env->yieldContent('sl-messages'); ?>">
            ...
            ?>
            <?php if($unreadMsgs > 0): ?><span class="sidebar-badge"><?php echo e($unreadMsgs); ?></span><?php endif; ?>
        </a>
        <a href="<?php echo e(route('notifications.index')); ?>"  class="sidebar-link <?php echo $__env->yieldContent('sl-notifs'); ?>"><span class="sl-icon"><i class="fas fa-bell"></i></span>Notifications</a>
        <a href="<?php echo e(route('user.profile')); ?>"         class="sidebar-link <?php echo $__env->yieldContent('sl-profile'); ?>"><span class="sl-icon"><i class="fas fa-user"></i></span>Profile</a>
        ...
        <a href="<?php echo e(route('driver.dashboard')); ?>" class="sidebar-link <?php echo $__env->yieldContent('sl-dashboard'); ?>"><span class="sl-icon"><i class="fas fa-motorcycle"></i></span>Dashboard</a>
        <a href="<?php echo e(route('driver.earnings')); ?>"  class="sidebar-link <?php echo $__env->yieldContent('sl-earnings'); ?>"><span class="sl-icon"><i class="fas fa-money-bill-wave"></i></span>Earnings</a>
        <a href="<?php echo e(route('driver.stats')); ?>"     class="sidebar-link <?php echo $__env->yieldContent('sl-stats'); ?>"><span class="sl-icon"><i class="fas fa-chart-line"></i></span>Statistics</a>

        <div class="sidebar-divider"></div>
        <div class="sidebar-section">Vehicle & Profile</div>
        <a href="<?php echo e(route('driver.profile')); ?>"       class="sidebar-link <?php echo $__env->yieldContent('sl-profile'); ?>"><span class="sl-icon"><i class="fas fa-id-card"></i></span>Profile</a>
        <a href="<?php echo e(route('driver.vehicle.index')); ?>" class="sidebar-link <?php echo $__env->yieldContent('sl-vehicle'); ?>"><span class="sl-icon"><i class="fas fa-wrench"></i></span>Maintenance</a>

        <div class="sidebar-divider"></div>

        <a href="<?php echo e(route('messages.index')); ?>"   class="sidebar-link <?php echo $__env->yieldContent('sl-messages'); ?>"><span class="sl-icon"><i class="fas fa-comments"></i></span>Messages</a>
        <a href="<?php echo e(route('notifications.index')); ?>" class="sidebar-link <?php echo $__env->yieldContent('sl-notifs'); ?>"><span class="sl-icon"><i class="fas fa-bell"></i></span>Notifications</a>
        <form action="<?php echo e(route('logout')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <button type="submit" class="sidebar-link"><span class="sl-icon"><i class="fas fa-sign-out-alt"></i></span>Logout</button>
        ...
        <?php $pendingCount = \App\Models\DriverRequest::where('status', 'pending')->count(); ?>

        <div class="sidebar-section">Overview</div>
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-link <?php echo $__env->yieldContent('sl-dashboard'); ?>"><span class="sl-icon"><i class="fas fa-chart-pie"></i></span>Dashboard</a>
        <a href="<?php echo e(route('admin.monitor')); ?>"   class="sidebar-link <?php echo $__env->yieldContent('sl-monitor'); ?>"><span class="sl-icon"><i class="fas fa-satellite-dish"></i></span>Live Monitor</a>

        <div class="sidebar-divider"></div>
        <div class="sidebar-section">Manage</div>
        <a href="<?php echo e(route('admin.foods.index')); ?>"  class="sidebar-link <?php echo $__env->yieldContent('sl-foods'); ?>"><span class="sl-icon"><i class="fas fa-hamburger"></i></span>Foods</a>
        <a href="<?php echo e(route('admin.orders.index')); ?>" class="sidebar-link <?php echo $__env->yieldContent('sl-orders'); ?>"><span class="sl-icon"><i class="fas fa-box"></i></span>Orders</a>
        <a href="<?php echo e(route('admin.users')); ?>"        class="sidebar-link <?php echo $__env->yieldContent('sl-users'); ?>"><span class="sl-icon"><i class="fas fa-users"></i></span>Users</a>
        <a href="<?php echo e(route('admin.drivers')); ?>"      class="sidebar-link <?php echo $__env->yieldContent('sl-drivers'); ?>"><span class="sl-icon"><i class="fas fa-motorcycle"></i></span>Drivers</a>
        
            

        <div class="sidebar-divider"></div>
        <div class="sidebar-section">System</div>
        <a href="<?php echo e(route('admin.audit-logs')); ?>"    class="sidebar-link <?php echo $__env->yieldContent('sl-audit'); ?>"><span class="sl-icon"><i class="fas fa-history"></i></span>Audit Logs</a>
        <a href="<?php echo e(route('admin.suspicious')); ?>"    class="sidebar-link <?php echo $__env->yieldContent('sl-security'); ?>"><span class="sl-icon"><i class="fas fa-shield-alt"></i></span>Security</a>
        <a href="<?php echo e(route('admin.reports')); ?>"       class="sidebar-link <?php echo $__env->yieldContent('sl-reports'); ?>"><span class="sl-icon"><i class="fas fa-chart-line"></i></span>Reports</a>
        <a href="<?php echo e(route('admin.promos.index')); ?>"  class="sidebar-link <?php echo $__env->yieldContent('sl-promos'); ?>"><span class="sl-icon"><i class="fas fa-ticket-alt"></i></span>Promo Codes</a>
        <a href="<?php echo e(route('messages.index')); ?>"      class="sidebar-link <?php echo $__env->yieldContent('sl-messages'); ?>"><span class="sl-icon"><i class="fas fa-comments"></i></span>Messages</a>
        ...
        <div class="sidebar-user-card">
            <div class="suc-initials"><?php echo e(strtoupper(substr(auth()->user()->name, 0, 2))); ?></div>
            <div class="suc-info">
                <div class="suc-name"><?php echo e(auth()->user()->name); ?></div>
                <div class="suc-role"><?php echo e(ucfirst(auth()->user()->role)); ?></div>
            </div>
            <form action="<?php echo e(route('logout')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<script>
function toggleDark() {
    fetch('<?php echo e(route("dark-mode")); ?>', {
        method: 'POST',
        headers: {
...
(function pollNotifs() {
    fetch('<?php echo e(route("notifications.count")); ?>', { credentials: 'same-origin' })
...
(function pollCart() {
    fetch('<?php echo e(route("user.cart.count")); ?>', { credentials: 'same-origin' })
        .then(r => { if (r.status === 419) return window.location.reload(); return r.json(); })
        .then(d => {
...
</html><?php /**PATH C:\xampp\htdocs\KAS-food-deliveryY\KAS-food-delivery\resources\views\layouts\app.blade.php ENDPATH**/ ?>