...
<?php $__env->startSection('title', 'Add Promo Code'); ?>
...
unset($__errorArgs, $__bag); ?>" 
                    value="<?php echo e(old('code')); ?>" placeholder="e.g., SAVE20, WELCOME10" required style="text-transform: uppercase">
...
unset($__errorArgs, $__bag); ?>" 
                    value="<?php echo e(old('discount_percent')); ?>" min="1" max="100" step="1" required>
...
unset($__errorArgs, $__bag); ?>" 
                    value="<?php echo e(old('max_uses', 100)); ?>" min="1" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="datetime-local" name="expires_at" class="form-control <?php $__errorArgs = ['expires_at'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="display: flex; gap: 1rem; margin-top: 1.5rem;">
                ...
                <a href="<?php echo e(route('admin.promos.index')); ?>" class="btn btn-outline">
                    Cancel
                </a>
            </div>
        </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\KAS-food-deliveryY\KAS-food-delivery\resources\views\admin\promos\create.blade.php ENDPATH**/ ?>