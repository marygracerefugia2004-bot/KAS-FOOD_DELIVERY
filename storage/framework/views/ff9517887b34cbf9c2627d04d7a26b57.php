    ...
    <div style="display: grid; grid-template-columns: 1fr 350px; gap: 1.5rem;">
        ...
        <div class="card">
            ...
            <div style="display: flex; align-items: center; gap: 1rem; padding: 1rem; border-bottom: 1px solid var(--border);">
                <?php if($item->food && $item->food->image_path): ?>
                    <?php if(str_starts_with($item->food->image_path, 'http')): ?>
                        <img src="<?php echo e($item->food->image_path); ?>" style="width: 70px; height: 70px; border-radius: 10px; object-fit: cover;">
                    <?php elseif(Storage::disk('public')->exists($item->food->image_path)): ?>
                ...
                <?php endif; ?>
                <div style="flex: 1">
                    <div style="font-weight: 700"><?php echo e($item->food->name ?? 'Item'); ?></div>
                    <div style="color: var(--orange); font-weight: 600">₱<?php echo e(number_format($item->food->price ?? 0, 2)); ?></div>
                </div>
                <div style="display: flex; align-items: center; gap: .5rem;">
                    <button type="button" onclick="updateQuantity(<?php echo e($item->id); ?>, 'decrease')" class="btn btn-sm btn-outline" <?php echo e($item->quantity <= 1 ? 'disabled' : ''); ?>>-</button>
                    <span id="quantity-<?php echo e($item->id); ?>" style="font-weight: 700; min-width: 30px; text-align: center;"><?php echo e($item->quantity); ?></span>
                    <button type="button" onclick="updateQuantity(<?php echo e($item->id); ?>, 'increase')" class="btn btn-sm btn-outline">+</button>
                </div>
                <div style="font-weight: 700; min-width: 80px; text-align: right;">
                    ₱<?php echo e(number_format(($item->food->price ?? 0) * $item->quantity, 2)); ?>
        ...
        <div class="card" style="height: fit-content;">
            ...
            <form action="<?php echo e(route('user.cart.checkout')); ?>" method="POST">
                ...
                <div style="display: flex; justify-content: space-between; margin-bottom: .5rem;">
                    <span>Subtotal</span>
                    <span style="font-weight: 700">₱<?php echo e(number_format($total, 2)); ?></span>
                </div>
                ...
                <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem;">
                    ...
                    <span style="font-weight: 700; color: var(--orange); font-size: 1.2rem;">₱<?php echo e(number_format($total + 50, 2)); ?></span>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\KAS-food-deliveryY\KAS-food-delivery\resources\views\cart\index.blade.php ENDPATH**/ ?>